...
// MovieReviews component displays reviews for a movie
export default function MovieReviews() {
  ...
  // Function to find the review of the profile owner
  ...
  // Functions to manage modals visibility
  ...
  // Fetch reviews when the movieId changes
  useEffect(() => {
...
const ReviewCard = ({ review }) => {
  ...
  return (
    <div className="flex space-x-3">
      {/* Display user avatar with initial letter */}
      ...
      <div>
        {/* Display user name, rating, and review content */}
